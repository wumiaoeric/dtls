...
func ciphersOpenSSL(cfg *dtls.Config) string {
	...
	translate := map[dtls.CipherSuiteID]string{
		...
		dtls.TLS_ECDHE_ECDSA_WITH_AES_256_GCM_SHA384: "ECDHE_ECDSA_WITH_AES_256_GCM_SHA384",
		dtls.TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384:   "ECDHE_RSA_WITH_AES_256_GCM_SHA384",
